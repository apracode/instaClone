...
function NotificationList({ hide }) {
  const classes = useNotificationListStyles();
  const notificationRef = useRef();
  useOutsideClick(notificationRef, hide);

  return (
    <Grid ref={notificationRef} className={classes.listContainer} container>
            ...
            <div className={classes.listItemWrapper}>
              ...
              <div className={classes.nameWrapper}>
                ...
                >
                  ...
                  {isFollow && `started following you. 2w`}
                </Typography>
              </div>
            </div>
            <div>
